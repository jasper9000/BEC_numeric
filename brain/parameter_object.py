...
Psi0 : {}\n\
Psi0 parameters : {}".format(self.x_low, self.x_high, self.y_low, self.y_high, self.resolutionX, self.resolutionY, self.beta2, self.omega, self.epsilon_limit, self.dt,
